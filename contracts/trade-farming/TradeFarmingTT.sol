...
import "../interfaces/ITradeFarmingTT.sol";
...
contract TradeFarming is ITradeFarmingTT, Ownable {
    ...
    // First token of pair interface (Which will be calculated for the volume)
    IERC20 tokenA;
    // Second token of pair interface
    IERC20 tokenB;
     ...
     * @param _tokenAAddress IERC20 - address of the first token of the pair
     * @param _tokenBAddress IERC20 - address of the second token of the pair
    ...
    function claimAllRewards() external virtual override {
        ...
        for (uint256 i = 0; i < len; i++) {
            require(
                ...
                "[claimAllRewards] Unsuccessful set operation"
            );
        }
    ...
    /**
     * @notice Swaps the specified amount of token A/B for the other token by connecting to the DEX Router and records the trade volumes
     * @dev @param @return Takes and returns the same parameters and values with router functions. 
                           See at: https://docs.uniswap.org/protocol/V2/reference/smart-contracts/router-01#swapexacttokensfortokens
     */
     ...
     * @dev @param @return Takes and returns the same parameters and values with router functions. 
                           See at: https://docs.uniswap.org/protocol/V2/reference/smart-contracts/router-01#swaptokensforexacttokens
     */
